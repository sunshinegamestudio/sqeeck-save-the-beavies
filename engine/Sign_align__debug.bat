rem "G:\Development\GameDev\jMP\PlatformGame\engine\dist\Sqeeck_Save_The_Beavies-release-signed.apk"
rem "G:\Development\GameDev\jMP\PlatformGame\engine\dist\Sqeeck_Save_The_Beavies-release-signed-aligned.apk"
